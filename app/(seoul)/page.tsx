...
export default function HomePage() {
  ...
  return (
    <div className="flex-1 flex justify-center items-start md:items-center px-4 md:px-6 py-8 md:py-12">
      <div className="w-full max-w-3xl flex flex-col">
        <p className="text-sm text-foreground-muted mb-3">
          {user ? `${greeting}, ${user.name}님` : greeting}
        </p>

        <h1 className="text-3xl md:text-4xl lg:text-[42px] font-semibold tracking-tight leading-snug mb-6 md:mb-8">
          서울 상권,
          <br />
